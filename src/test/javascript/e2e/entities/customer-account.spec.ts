...
describe('CustomerAccount e2e test', () => {
    ...
    it('should load CustomerAccounts', () => {
        entityMenu.click();
        element.all(by.css('[routerLink="customer-account"]')).first().click().then(() => {
            const expectVal = /Customer Accounts/;
