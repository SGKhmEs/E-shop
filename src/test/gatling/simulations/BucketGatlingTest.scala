...
/**
 * Performance test for the Bucket entity.
 */
class BucketGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Bucket entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created bucket")
                .get("${new_bucket_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created bucket")
            .delete("${new_bucket_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
